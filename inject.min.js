...
function changePage(page) {
  // console.log("changePage(page) : page.name = " + page.name)
...
function randomWebsite(){
  ...
  do {
    ...
    var returnedPage = m_websites.websites[randomIndex];
    // console.log(returnedPage.name + " chosen, show? " + returnedPage.show);
  } while (returnedPage.show == false);
  // console.log(randomIndex)
  // console.log(m_websites.websites[randomIndex].name + " chosen");
  return m_websites.websites[randomIndex];
}
